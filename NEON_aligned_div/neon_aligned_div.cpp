...
int main()
{
    setmatix(100);
    timestart();
    neon_aligned_div(100);
    timestop();

    setmatix(300);
    timestart();
    neon_aligned_div(300);
    timestop();

    setmatix(600);
    timestart();
    neon_aligned_div(600);
    timestop();

    setmatix(1024);
    timestart();
    neon_aligned_div(1024);
    timestop();

    setmatix(1200);
    timestart();
    neon_aligned_div(1200);
    timestop();

    setmatix(1400);
    timestart();
    neon_aligned_div(1400);
    timestop();

    setmatix(1600);
    timestart();
    neon_aligned_div(1600);
    timestop();

    setmatix(1800);
    timestart();
    neon_aligned_div(1800);
    timestop();

    setmatix(2000);
    timestart();
    neon_aligned_div(2000);
    timestop();

    setmatix(2024);
    timestart();
    neon_aligned_div(2024);
    timestop();
    return 0;
}
